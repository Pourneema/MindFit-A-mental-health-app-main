...
//       {
//         id: 1,
//         image: 'http://192.168.1.8:5000/get_image/2',
...
//           }
//         }, 1000); // Simulating a delay in fetching data (1 second)
//       } catch (error) {
...
//   //   return (score / 100) * 100; // Adjust this formula as needed
//   // };
//   return (
...
//               {apiData &&
//                 apiData.recommendations.map(async (item) => {
//                   try {
//                     const imageData = await AsyncStorage.getItem(`image_${item.id}`);
//                     return (
...
//                     return null; // or some default content if retrieval fails
//                   }
//                 })}
//             </ScrollView>
//           </View>
...
const App = () => {
  const dummyData = {
    ...
    recommendations: [
      {
        id: 1,
        image: 'http://192.168.73.244:5000/get_image/1',
        description: 'Short description about the article 1',
        link: 'https://www.example.com/article1',
      },
      {
        id: 2,
        image: 'http://192.168.73.244:5000/get_image/2',
        description: 'Short description about the article 2',
        link: 'https://www.example.com/article2',
      },
      {
        id: 3,
        image: 'http://192.168.73.244:5000/get_image/3',
        description: 'Short description about the article 2',
        link: 'https://www.example.com/article2',
      },
      {
        id: 4,
        image: 'http://192.168.73.244:5000/get_image/4',
        description: 'Short description about the article 2',
        link: 'https://www.example.com/article2',
      },
      // Add more recommendation objects as needed
